...
(function() {
  var NaClDecryptStream, NaClEncryptStream, armor, header, msgpack, nacl, nonce, noop, payload, saltpack_block_len, stream,
  ...
  exports.NaClDecryptStream = NaClDecryptStream = (function(_super) {
    ...
    function NaClDecryptStream(_decryptor) {
      ...
      this._block_num = 0;
      NaClDecryptStream.__super__.constructor.call(this, this._decrypt, saltpack_block_len, true, {
