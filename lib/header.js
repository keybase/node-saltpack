...
(function() {
  ...
  exports.generate_encryption_header_packet = function(encryptor, recipients, opts) {
    var crypto_hash, ephemeral_encryptor, exposed_recipients, header_hash, header_intermediate, header_list, i, mac_keys, payload_encryptor, payload_key, rec_pair, rec_payload, rec_pubkey, recipients_list, sender_key, sender_sbox, _i, _j, _len, _ref;
    header_list = [];
    ...
    sender_key = encryptor.publicKey != null ? encryptor.publicKey : payload_key;
    sender_sbox = payload_encryptor.secretbox({
      plaintext: sender_key,
